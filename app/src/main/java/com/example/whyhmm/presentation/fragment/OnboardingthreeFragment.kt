...
import com.example.whyhmm.databinding.FragmentOnboardingthreeBinding
...
import com.example.whyhmm.presentation.fragment.viewmodel.OnboardingThreeViewmodel
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class OnboardingthreeFragment : BaseFragment<FragmentOnboardingthreeBinding,OnboardingThreeViewmodel>(){
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            submitBtn.setOnClickListener {
                val action=OnboardingthreeFragmentDirections.actionOnboardingthreeToLogin()
