...
class PopularmarketingAdapter : RecyclerView.Adapter<PopularmarketingAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, p1: Int): ViewHolder {
        val v = CourseItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return ViewHolder(v)
    }
}